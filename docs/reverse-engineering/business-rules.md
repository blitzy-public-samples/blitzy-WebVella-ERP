...
| **PROC-004** | Record create/update/delete/search operations fire **Pre** and **Post** extension hooks | `WebVella.Erp/Hooks/IErpPreCreateRecordHook.cs:6-9` | Eight record-hook interfaces under `WebVella.Erp/Hooks/`, each declaring a single hook method: `WebVella.Erp/Hooks/IErpPreCreateRecordHook.cs:6-9` / `WebVella.Erp/Hooks/IErpPostCreateRecordHook.cs:5-8`, `WebVella.Erp/Hooks/IErpPreUpdateRecordHook.cs:6-9` / `WebVella.Erp/Hooks/IErpPostUpdateRecordHook.cs:5-8`, `WebVella.Erp/Hooks/IErpPreDeleteRecordHook.cs:6-9` / `WebVella.Erp/Hooks/IErpPostDeleteRecordHook.cs:5-8`, `WebVella.Erp/Hooks/IErpPreSearchRecordHook.cs:7-10` / `WebVella.Erp/Hooks/IErpPostSearchRecordHook.cs:6-9`. Pre-hooks receive a `List<ErrorModel>` and can add errors to veto the operation (`WebVella.Erp/Hooks/IErpPreCreateRecordHook.cs:9`). |
| **PROC-005** | Many-to-many relation changes fire **Pre** and **Post** hooks | `WebVella.Erp/Hooks/IErpPreCreateManyToManyRelationHook.cs:7-10` | Four relation-hook interfaces under `WebVella.Erp/Hooks/`: `WebVella.Erp/Hooks/IErpPreCreateManyToManyRelationHook.cs:7-10` / `WebVella.Erp/Hooks/IErpPostCreateManyToManyRelationHook.cs:5-8`, `WebVella.Erp/Hooks/IErpPreDeleteManyToManyRelationHook.cs:7-10` / `WebVella.Erp/Hooks/IErpPostDeleteManyToManyRelationHook.cs:5-8`. Together with PROC-004 these are the **12** `IErp*Hook` extension points defined in the README glossary. |
